...
class Ui_AnalyseDialog(object):
    def setupUi(self, AnalyseDialog):
        ...
        self.checkWinsorize.setGeometry(QtCore.QRect(550, 10, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.winsorizeLimit.setGeometry(QtCore.QRect(675, 35, 46, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_201.setGeometry(QtCore.QRect(605, 35, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, AnalyseDialog):
        ...
        self.checkWinsorize.setText(_translate("AnalyseDialog", "Winsorize"))
