...
class Ui_ImageDialog(object):
    ...
    def retranslateUi(self, ImageDialog):
        ...
        self.btn_crosshair.setToolTip(_translate("ImageDialog", "<html><head/><body><p>Shows a crosshair in front of the image</p></body></html>"))
        ...
        self.btn_size25.setText(_translate("ImageDialog", "1x"))
        self.btn_size50.setText(_translate("ImageDialog", "2x"))
        self.btn_size100.setText(_translate("ImageDialog", "4x"))
