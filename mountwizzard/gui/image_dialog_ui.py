...
class Ui_ImageDialog(object):
    def setupUi(self, ImageDialog):
        ...
        self.le_cameraStatus = QtWidgets.QLineEdit(ImageDialog)
        self.le_cameraStatus.setGeometry(QtCore.QRect(400, 70, 121, 21))
        font = QtGui.QFont()
        font.setFamily("Courier")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.le_cameraStatus.setFont(font)
        self.le_cameraStatus.setMouseTracking(False)
        self.le_cameraStatus.setAcceptDrops(False)
        self.le_cameraStatus.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.le_cameraStatus.setMaxLength(15)
        self.le_cameraStatus.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.le_cameraStatus.setReadOnly(False)
        self.le_cameraStatus.setObjectName("le_cameraStatus")
...
"Exposures"))
        ...
        self.le_cameraStatus.setToolTip(_translate("ImageDialog", "<html><head/><body><p>IP address of relay switch</p></body></html>"))
        self.le_cameraStatus.setText(_translate("ImageDialog", "---"))
