...
class Ui_ImageDialog(object):
    def setupUi(self, ImageDialog):
        ...
        self.btn_crosshair.setGeometry(QtCore.QRect(300, 10, 81, 26))
        font = QtGui.QFont()
        ...
        self.btn_solve.setGeometry(QtCore.QRect(10, 70, 81, 26))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.le_imageFile.setGeometry(QtCore.QRect(10, 40, 371, 26))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        font.setBold(False)
        ...
        self.le_RaJ2000.setGeometry(QtCore.QRect(175, 70, 81, 26))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.le_DecJ2000.setGeometry(QtCore.QRect(300, 70, 81, 26))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.btn_loadFits.setGeometry(QtCore.QRect(110, 10, 81, 26))
        self.btn_loadFits.setObjectName("btn_loadFits")
        self.label_85 = QtWidgets.QLabel(ImageDialog)
        self.label_85.setGeometry(QtCore.QRect(150, 70, 26, 26))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_85.setFont(font)
        self.label_85.setObjectName("label_85")
        self.label_86 = QtWidgets.QLabel(ImageDialog)
        self.label_86.setGeometry(QtCore.QRect(270, 70, 26, 26))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, ImageDialog):
        ...
        self.le_astrometryStatusText.setToolTip(_translate("ImageDialog", "Status feedback from mount "))
        self.le_cameraStatusText.setToolTip(_translate("ImageDialog", "Status feedback from mount "))
        self.le_imageFile.setToolTip(_translate("ImageDialog", "Status feedback from mount "))
        self.le_RaJ2000.setToolTip(_translate("ImageDialog", "Status feedback from mount "))
        self.le_DecJ2000.setToolTip(_translate("ImageDialog", "Status feedback from mount "))
