...
class Ui_CoordinateDialog(object):
    def setupUi(self, CoordinateDialog):
        ...
        self.le_modelingStatusTime.setGeometry(QtCore.QRect(300, 570, 41, 21))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.label_12.setGeometry(QtCore.QRect(180, 570, 111, 21))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.label_13.setGeometry(QtCore.QRect(350, 570, 51, 21))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
