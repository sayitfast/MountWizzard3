...
class MountWizzardApp(widget.MwWidget):
    ...
    def __init__(self):
        ...
        # Windows opening
        self.ui.btn_openMessageWindow.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\note_accept.ico'))
        self.ui.btn_openMessageWindow.setStyleSheet('background-color: rgb(16,72,124);color: rgb(255,255,255);text-align: left; padding-left: 5px;')
        self.ui.btn_openMessageWindow.setIconSize(PyQt5.QtCore.QSize(20, 20))
        self.ui.btn_openAnalyseWindow.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\chart.ico'))
        self.ui.btn_openAnalyseWindow.setStyleSheet('background-color: rgb(16,72,124);color: rgb(255,255,255);text-align: left; padding-left: 5px;')
        self.ui.btn_openAnalyseWindow.setIconSize(PyQt5.QtCore.QSize(20, 20))
        self.ui.btn_openImageWindow.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\image.ico'))
        self.ui.btn_openImageWindow.setStyleSheet('background-color: rgb(16,72,124);color: rgb(255,255,255);text-align: left; padding-left: 5px;')
        self.ui.btn_openImageWindow.setIconSize(PyQt5.QtCore.QSize(20, 20))
        self.ui.btn_openModelingPlotWindow.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\processes.ico'))
        self.ui.btn_openModelingPlotWindow.setStyleSheet('background-color: rgb(16, 72, 124);color: rgb(255,255,255);text-align: left; padding-left: 5px;')
        self.ui.btn_openModelingPlotWindow.setIconSize(PyQt5.QtCore.QSize(20, 20))
        # buttons for the configuration
        self.ui.btn_saveConfigAs.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\database_down.ico'))
        self.ui.btn_saveConfigAs.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_saveConfigAs.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_loadFrom.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\database_up.ico'))
        self.ui.btn_loadFrom.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_loadFrom.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_saveConfig.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\floppy_disc.ico'))
        self.ui.btn_saveConfig.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_saveConfig.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_saveConfigQuit.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\eject.ico'))
        self.ui.btn_saveConfigQuit.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_saveConfigQuit.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_mountBoot.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\computer_accept.ico'))
        self.ui.btn_mountBoot.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_mountBoot.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_mountShutdown.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\computer_remove.ico'))
        self.ui.btn_mountShutdown.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_mountShutdown.setIconSize(PyQt5.QtCore.QSize(16, 16))
        # buttons for running and other
        self.ui.btn_runBaseModel.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\play.ico'))
        self.ui.btn_runBaseModel.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_runBaseModel.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_cancelModel1.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\stop.ico'))
        self.ui.btn_cancelModel1.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_cancelModel1.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_runRefinementModel.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\play.ico'))
        self.ui.btn_runRefinementModel.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_runRefinementModel.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_cancelModel2.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\stop.ico'))
        self.ui.btn_cancelModel2.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_cancelModel2.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_deletePoints.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\application_remove.ico'))
        self.ui.btn_deletePoints.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_deletePoints.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_loadBasePoints.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\floppy_disc_add.ico'))
        self.ui.btn_loadBasePoints.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_loadBasePoints.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_generateBasePoints.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\process_add.ico'))
        self.ui.btn_generateBasePoints.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_generateBasePoints.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_plateSolveSync.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\calculator_accept.ico'))
        self.ui.btn_plateSolveSync.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_plateSolveSync.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_loadRefinementPoints.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\floppy_disc_add.ico'))
        self.ui.btn_loadRefinementPoints.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_loadRefinementPoints.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_generateGridPoints.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\process_add.ico'))
        self.ui.btn_generateGridPoints.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_generateGridPoints.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_generateMaxPoints.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\process_add.ico'))
        self.ui.btn_generateMaxPoints.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_generateMaxPoints.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_generateNormalPoints.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\process_add.ico'))
        self.ui.btn_generateNormalPoints.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_generateNormalPoints.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_generateMinPoints.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\process_add.ico'))
        self.ui.btn_generateMinPoints.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_generateMinPoints.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_generateDSOPoints.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\favorite_add.ico'))
        self.ui.btn_generateDSOPoints.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_generateDSOPoints.setIconSize(PyQt5.QtCore.QSize(16, 16))
        ...
        self.ui.btn_runCheckModel.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_runBoostModel.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\play.ico'))
        self.ui.btn_runBoostModel.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_runBoostModel.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_runTimeChangeModel.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\play.ico'))
        self.ui.btn_runTimeChangeModel.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_runTimeChangeModel.setIconSize(PyQt5.QtCore.QSize(16, 16))
        self.ui.btn_runHystereseModel.setIcon(PyQt5.QtGui.QIcon(self.bundle_dir + '\\icons\\play.ico'))
        self.ui.btn_runHystereseModel.setStyleSheet('background-color: rgb(25,25,25);color: rgb(192,192,192);text-align: left; padding-left: 5px;')
        self.ui.btn_runHystereseModel.setIconSize(PyQt5.QtCore.QSize(16, 16))
