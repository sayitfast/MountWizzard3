...
class MountModelHandling:
    ...
    def saveModel(self, target):
        ...
        if num == -1:
            ...
            return False
        self.app.mount.mountHandler.sendCommand('modeldel0' + target)
        reply = self.app.mount.mountHandler.sendCommand('modelsv0' + target)
        if reply == '1':
    ...
    def loadModel(self, target):
        ...
        if num == -1:
            ...
            return False
        reply = self.app.mount.mountHandler.sendCommand('modelld0' + target)
        if reply == '1':
